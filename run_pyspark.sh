...
export IGNITE_JARS=$IGNITE_HOME/libs/ignite-zookeeper/ignite-zookeeper-2.7.6.jar,$IGNITE_JARS
export IGNITE_JARS=$IGNITE_HOME/libs/ignite-zookeeper/zookeeper-3.4.13.jar,$IGNITE_JARS

export IGNITE_JARS=$IGNITE_HOME/libs/ignite-zookeeper/jackson-core-asl-1.9.13.jar,$IGNITE_JARS
export IGNITE_JARS=$IGNITE_HOME/libs/ignite-zookeeper/jackson-mapper-asl-1.9.13.jar,$IGNITE_JARS
export IGNITE_JARS=$IGNITE_HOME/libs/ignite-zookeeper/guava-16.0.1.jar,$IGNITE_JARS


echo $IGNITE_JARS

$SPARK_HOME/bin/pyspark --jars $IGNITE_JARS --master spark://192.168.86.25:7077
